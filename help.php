...
<ul>
	...
	<li><span class="question">I have been using a TAL card (The Alberta Library). Why would I use the Me Card service?</span>
		<span class="answer">Your TAL card is valid at all participating library systems in Alberta, including the libraries that make up the Me Card service. However, the TAL card provides more limited access to collections and services, and requires a separate card and in-person registration with each library you wish to use.</span>
	</li>
